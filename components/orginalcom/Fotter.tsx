...
function Fotter() {
  return (
    <div className=' w-full h-[50px] items-center bg-[#191b24] flex-col bg-[#333338 min-h-[50vh] text-white flex  justify-center px-3'>
      ...
      <Link href={"/"} className=" flex items-center font-semibold mb-20 text-4xl gap-3"> 
      <Ticket size="52" color="#0a73fd" variant="Bulk"/> Tickets / Get Your Tickets Now 
      </Link>
      <p className=" w-[80%] text-xs ">Copyright 2024 Bigtree Entertainment Pvt. Ltd. All Rights Reserved.
